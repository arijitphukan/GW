...
<body>
    <nav class="navbar navbar-expand-md" style="min-height: 80px; background-color:#4b63826f;">
        <div class="container position-relative">
            <h1 class="text-uppercase logo m-0 position-absolute start-50 translate-middle-x mobile-logo" style="color: #bdb3a3; cursor:default; font-size: clamp(1.8rem, 4vw, 2.5rem);">
                GW
            </h1>
